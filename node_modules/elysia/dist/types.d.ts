...
export type InlineHandler<Route extends RouteSchema = {}, Singleton extends SingletonBase = {
    ...
    return: {};
    resolve: {};
}>= MaybePromise<InlineResponse> | ((context: Context<Route & MacroContext, Singleton & {
    resolve: MacroContext['resolve'];
}>) => MaybePromise<Response> | MaybePromise<{} extends Route['response'] ? unknown : (Route['response'] extends {
    200: any;
...
export type InlineHandlerNonMacro<Route extends RouteSchema = {}, Singleton extends SingletonBase = {
    ...
    derive: {};
    resolve: {};
}>= MaybePromise<InlineResponse> | ((context: Context<Route, Singleton>) => MaybePromise<Response> | MaybePromise<{} extends Route['response'] ? unknown : (Route['response'] extends {
    200: any;
...
export type ComposeElysiaResponse<Schema extends RouteSchema, Handle, Possibility extends PossibleResponse>= ReconcileStatus<Schema['response'], UnionResponseStatus<ValueOrFunctionToResponseSchema<Handle>, Possibility & (EmptyRouteSchema extends Pick<Schema, keyof EmptyRouteSchema> ? {} : {
    422: {
        type: 'validation';
        on: string;
        summary?: string;
...
export type ExtractErrorFromHandle<in out Handle>= {
    [ErrorResponse in Extract<Handle, AnyElysiaCustomStatusResponse> as ErrorResponse extends AnyElysiaCustomStatusResponse ? ErrorResponse['code'] : never]: Prettify<ErrorResponse['response']>;
};
...
] ? MergeElysiaInstances<Rest, Prefix, Singleton & Current['~Singleton'], Definitions & Current['~Definitions'], Metadata & Current['~Metadata'], Ephemeral, Volatile & Current['~Ephemeral'], Routes & (Prefix extends `` ? Current['~Routes'] : CreateEden<Prefix, Current['~Routes']>)> : Elysia<Prefix, {
    decorator: Singleton['decorator'];
